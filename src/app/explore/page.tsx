        ...
        {moodOfTheDay && (
          <div 
            ...
            style={{ 
              ...
              borderColor: activeMood === moodOfTheDay.mood ? '#fff' : '#c87941' 
            }}
          >
            <span className="text-[10px] font-bold tracking-widest uppercase mb-1" style={{ color: '#c87941' }}>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button onClick={(e) => toggleLike(e, song._id)} className="p-1 text-gray-400 hover:text-white transition-colors">
                      <svg className={`w-4 h-4 ${likedSongIds.has(song._id) ? 'text-[#c87941]' : ''}`} fill="currentColor" viewBox="0 0 24 24">
